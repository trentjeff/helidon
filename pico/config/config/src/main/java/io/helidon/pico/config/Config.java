 ...
 *
 * See {@link io.helidon.pico.config.ConfigValue}.
 */
@Contract
public interface Config {
     ...
     */
    default <T> ConfigValue<List<T>> asList(Class<T> type) throws ConfigMappingException {
        throw new ConfigMappingException(key(), "unsupported; do you have a valid config module in the classpath?");
    }
     ...
     */
    default ConfigValue<Map<String, String>> asMap() throws MissingValueException, ConfigMappingException {
        throw new ConfigMappingException(key(), "unsupported; do you have a valid config module in the classpath?");
    }
     ...
     * <ul>
     * <li>in {@link Config.Type#OBJECT} node the token represents a <strong>name of object member</strong>;</li>
     * <li>in {@link Config.Type#LIST} node the token represents an zero-based <strong>index of list
     * element</strong>,
    ...
    interface Key extends Comparable<Key> {
         ...
         * @see #isRoot()
         * @throws IllegalStateException in case you attempt to call this method on a root node, or if not defined
         */
        default Key parent() {
            throw new ConfigMappingException(this, "unsupported; do you have a valid config module in the classpath?");
        }
