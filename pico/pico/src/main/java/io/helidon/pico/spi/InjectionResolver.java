...
public interface InjectionResolver {
    ...
    /**
     * Used to indicate that there is no ability to resolve this request.
     */
    Object NOT_RESOLVABLE = null;
     ...
     * Phase 1 (resolveIps=false) is during time where the injection plan is being formulated. This is the time we need
     ...
     * @return the resolution for the plan or the injection point, or {@link #NOT_RESOLVABLE} if unable to resolve the injection point context
     */
    Object resolve(InjectionPointInfo ipInfo,
